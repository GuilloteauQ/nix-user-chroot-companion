...
# clear
echo "Activate Nix"
nix_user_chroot_bash="$nix_user_chroot_cmd $nix_store_dir bash --rcfile $nix_user_chroot_dir/nix_setenv.sh -ci 'cd $1; nix-shell --run \"poetry install && poetry run nxc build -f $2 -l -o $3\"'"
